	...
	module.controller( 'EditBudgetController', function ( $log, $scope, $state, $modal, growl, gettext, MPDBudgets, form, budget, isEditable, isAdmin, isApprover, isOwner ) {
		...
		$scope.requestApproval = function () {
			...
			$modal.open( {
				...
				scope:       $scope,
				keyboard:    false,
				templateUrl: 'app/states/ministry/budgets/budget/edit/approve.modal.html',
		...
		$scope.rejectBudget = function () {
			...
			$modal.open( {
				...
				scope:       $scope,
				keyboard:    false,
				templateUrl: 'app/states/ministry/budgets/budget/edit/reject.modal.html',
				controller:  function ( $scope, $modalInstance, $state ) {
		...
		$scope.deleteBudget = function () {
			...
			$modal.open( {
				...
				scope:       $scope,
				keyboard:    false,
				templateUrl: 'app/states/ministry/budgets/budget/edit/delete.modal.html',
				controller:  function ( $scope, $modalInstance, $state ) {
